...
const uint32_t COMMON_HEADER_SIZE =  NODE_TYPE_SIZE + IS_ROOT_SIZE + PARENT_POINTER_SIZE;

// for leaf nodes
const uint32_t LEAF_NODE_NUM_CELLS_SIZE = sizeof(uint32_t);
const unit32_t LEAF_NODE_NUM_CELLS_OFFSET = COMMON_HEADER_SIZE;
const uint32_t LEAF_NODE_HEADER_SIZE = COMMON_HEADER_SIZE + LEAF_NODE_NUM_CELLS_SIZE;
